var cityInput = document.querySelector("#city-id");
var cityBtn = document.querySelector("#search-btn");
var cityNameEl = document.querySelector("#city-name");
var cityArray = [];
var apiKey = "4622d3a752aacc2a2d407d2312209eb0";

var formHandler = function (event) {
  // formats city name (I got some help here from a buddy who knows coding much better than I do! Otherwise I wouldn't have been able to 'fix' the string for the list.)
